    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <form action="action.php?action=add" method="POST" enctype="multipart/form-data" class="form-horizontal">
                <div class="card-body">
                  <h4 class="card-title">Add new article form.</h4>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <select class="select2 form-select shadow-none" name="category" style="width: 100%; height: 36px"
                        required>
